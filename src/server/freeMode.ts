const ENCRYPTED_KEYS: string[] = [
  "FhkYWwEZE0MYUkIMBhRQB0pWU0sNBBUGV0JUBxUMARYGBBUDVUNQBRYNUEAFDEsEXUAMVkQHBxRWVxEEV0ANA0cFVBRTABBSUQ==",
]
...
export function getFallbackOpenRouterApiKey(): string | null {
  return getRandomFreeKey()
}
...
export function resolveOpenRouterApiKeyForProviderSwitch(
  apiKey: string,
  savedApiKey: string | undefined,
): string {
  return apiKey || savedApiKey || getFallbackOpenRouterApiKey() || ''
}
